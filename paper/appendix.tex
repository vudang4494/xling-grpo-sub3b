...
All paths are relative to \path{results/eval/}.}
\label{tab:sources}
\begin{tabular}{lll}
\toprule
...
\subsection{Training-curve limitation (Figure~5)}
Figure~5 reports mean $\pm \sigma$ across \emph{two} seeds (123 and 7) for
